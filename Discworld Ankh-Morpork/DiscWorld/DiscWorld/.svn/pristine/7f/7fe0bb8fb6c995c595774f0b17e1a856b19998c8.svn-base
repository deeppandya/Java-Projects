 ...
 * 
 * @author p_pandy
 * <p> Player card,from Green cards, Leonard of Quirm extends the PlayerCardActions.
 ...
 *
 */
public class LeonardOfQuirm extends PlayerCardActions {
	
	// scroll
	public LeonardOfQuirm(String name) {
		playerCardName=name;
