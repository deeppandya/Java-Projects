 ...
 * 
 * @author p_pandy
 * <p> Player card,from Green cards, Dr White Face extends the PlayerCardActions.
 * It overrides two methods of the PlayerCardActions. It has two events to do  1>Scroll and 2>Place a Minion.
 * </p>
 * @see scroll()
...
public class DrWhiteface extends PlayerCardActions {
	// scroll
	// place minion
	
	public DrWhiteface(String name) {
		playerCardName=name;
