 ...
 * 
 * @author p_pandy
 * <p> Player card,from Green cards, The Duck Man extends the PlayerCardActions.
...
public class TheDuckMan extends PlayerCardActions {
	//scroll
	
	public TheDuckMan(String name) {
		playerCardName=name;
	...
	public void scroll() {
		...
		do{
			...
			do{
				...
				System.out.println("Select adjacent ");
