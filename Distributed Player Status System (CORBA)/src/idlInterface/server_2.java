...
public class server_2 {
	...
	public static void main(String[] args)
	{
		try{
			...
			NameComponent nc = new NameComponent("DPSSserver_2", ""); //then make a NameComponent
	...
	{
		Log log = new Log("Europe");
		
		try {
			
			System.out.println("Server_2 is up and running");
			log.Info("Server started.");
			
			DatagramSocket _socket = null;
			try {
				_socket = new DatagramSocket(5678);
				log.Info("Socket created for Receiving status request from other servers at 5678...");
				...
				log.logger.log(Level.SEVERE,
						"Problem opening socket at port 5678...", e);
			}
