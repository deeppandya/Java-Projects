...
public class server_3 {
	...
	public static void main(String[] args)
	{
		try{
			...
			NameComponent nc = new NameComponent("DPSSserver_3", ""); //then make a NameComponent
	...
	{
		Log log = new Log("Asia");
		
		try {
			
			System.out.println("Server_3 is up and running");
			log.Info("Server started.");
			
			DatagramSocket _socket = null;
			try {
				_socket = new DatagramSocket(6789);
				log.Info("Socket created for Receiving status request from other servers at 6789...");
				...
				log.logger.log(Level.SEVERE,
						"Problem opening socket at port 6789...", e);
			}
